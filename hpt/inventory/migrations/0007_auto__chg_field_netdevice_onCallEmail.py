...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NetDevice.onCallEmail'
        db.alter_column(u'inventory_netdevice', 'onCallEmail', self.gf('django.db.models.fields.EmailField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'NetDevice.onCallEmail'
        db.alter_column(u'inventory_netdevice', 'onCallEmail', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'inventory.netdevice': {
            ...
            'onCallEmail': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            ...
            'tasks': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'devices'", 'blank': 'True', 'to': u"orm['djcelery.TaskState']"})
        }
    }
