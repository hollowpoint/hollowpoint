...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NetDevice.lastUpdate'
        db.delete_column(u'inventory_netdevice', 'lastUpdate')

        # Adding field 'NetDevice.created'
        db.add_column(u'inventory_netdevice', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'NetDevice.modified'
        db.add_column(u'inventory_netdevice', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NetDevice.lastUpdate'
        db.add_column(u'inventory_netdevice', 'lastUpdate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'NetDevice.created'
        db.delete_column(u'inventory_netdevice', 'created')

        # Deleting field 'NetDevice.modified'
        db.delete_column(u'inventory_netdevice', 'modified')
